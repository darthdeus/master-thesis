...
\todo{MS: Nevim, jak moc jsi se s tim zabyval, ale asi bych to tady moc
nezduraznoval [ze to "nejde"]. Napsal bych jen "Our implementation however does
not use this approach. Instead, we handle the problem explictly ..."}
