...
conditional distribution $p(x_1 | x_2)$ is a Gaussian. Because we know
...
In \autoref{eq:mvn-quadratic-form-12} we again observe a Gaussian density with
parameters
\begin{align}
...
\end{align}
This formula is extremely important for the use of GPs as a probabilistic
...
A \newterm{stationary kernel} is a one which is shift-invariant, which means its
