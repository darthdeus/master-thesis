...
We compare our achieved accuracy of $97.21\%$ to 10 repeats of the experiment with random search, which managed to achieve a higher value of accuracy in $3$ out of those $10$ attempts, which an overall best $97.28\%$. \todo{zkontrolovat jak dopadlo 10 boptu}
...
Similarly to the previous experiments the speech recognition model also has a steady convergence curve as shown in \autoref{figure:1d-marginal}. The best achieved value was $-26.81$, which \todo{doplnit podle toho kolik je baseline} the hand-tuned baseline model which achieved \todo{doplnit}.
...
\todo{pribalit vysledky experimentu a jak jednoduse pustit web}
